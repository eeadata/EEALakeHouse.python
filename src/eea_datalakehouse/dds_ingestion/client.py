...
only translates the four ingest endpoints to/from the typed models in
:mod:`eea_datalakehouse.dds_ingestion.models`. The orchestration logic lives in
:mod:`eea_datalakehouse.dds_ingestion.folder`.
